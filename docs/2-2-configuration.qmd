...
- [Collector ZIP](downloads/urban-wifi-capture.zip)
- [SHA-256 checksum](downloads/urban-wifi-capture.sha256)
...
```powershell
cd "$HOME\Downloads"
Get-ChildItem urban-wifi-capture*
```
...
The checksum must report `urban-wifi-capture.zip: OK`, and `pwd`
