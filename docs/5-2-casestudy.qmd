...
![**Inferred-stay patterns in a commercial district near the University of Ulsan.** (a) Sensor map: fill color = inferred-stay ratio, size = trajectories observed; blue line = pedestrian-priority street; B = bus stops. (b) Per-sensor ratios grouped by street type. (c) Ratio by qualifying observation-day band and street type; diamonds mark each band's weighted mean; labels report the pedestrian-priority minus conventional difference.](materials/ch5/fig3_activities.png)
