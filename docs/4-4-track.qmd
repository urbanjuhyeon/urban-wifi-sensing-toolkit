...
While [Count](4-3-count.qmd) summarizes observed presence, Track links successive locations of the same retained pseudonymous identifier. This chapter builds origin--destination (OD) matrices and flow maps that reveal recurring observed corridors across a study area.
