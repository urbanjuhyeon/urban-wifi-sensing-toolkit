...
::: {.callout-note collapse="true" title="Hardware costs"}
...
For comparison, the **Raspberry Pi 3 Model B+ board alone** was listed at **USD 40 in September 2026**.[^pi-board-price]

[^pi-board-price]: PiShop.us, "Raspberry Pi 3 Model B Plus (B+)," <https://www.pishop.us/product/raspberry-pi-3-model-b-plus/> (accessed 6 September 2026).
